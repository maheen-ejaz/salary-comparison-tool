...
import { NzResultsPanel } from "@/components/results/NzResultsPanel";
...
export function NzPageClient({ data, config, liveRate, rateIsLive, rateDate, allCountryData, allRates }: Props) {
