...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-black/50 backdrop-blur transition-opacity duration-300",
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 shadow-lg transition-transform duration-300 ease-in-out",
          "bg-[var(--neutral-50)]",
          side === "right" &&
      ...
      >
        {children}
        {showClose && (
          <SheetPrimitive.Close className="absolute top-5 right-5 rounded-full transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
